     ...
     <div class="container-fluid main-content">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
                  ...
                  <center>
                      <img src="../images/<?php echo $img ; ?>" id="catimg" class="form-control">
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <h2> Background Image</h2>
                  <center>
                      <img src="../images/<?php echo $vidimg ; ?>" id="catimg" class="form-control">
          ...
          <br>
                  ...
                  <h3>Video Frame</h3>
          <textarea name="vid" class="form-control"> <?php echo $vid ?> </textarea>
...
<br>
    ...
    <br>
                ...
                <input type="submit" name="submitvid" class="btn">
            </center>
