...
<?php if(1==0){ ?>
  <div class="menuFooter clearfix" style="background: #147e07">
    <div class="container">
      <div class="row clearfix">
        ...
        <div class="col-sm-3 col-xs-12 borderLeft">
          ...
          $rows =mysqli_query($con,"SELECT name,slug,res FROM pages where res=1  ORDER BY ordr" ) or die(mysqli_error($con));
