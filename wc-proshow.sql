...
--
-- Host: 127.0.0.1:3306
-- Generation Time: May 04, 2020 at 08:40 AM
...
(2, 14, 'add-brands', 'Best in Class', '18aebe3864c213cc3dcfd39eb47f4b4c1.png', '', 3, 1),
(3, 14, 'add-brands', 'Urdu', '028527f4b32512ae4379915bee6cb5571.png', '', 4, 1);
...
(9, 'Contact Us', 'contacts', 'Contacts', 'Contacts', '123.jpg', '', 1, 20),
(24, 'Clients', 'clients', 'clients ', 'clients ', '9de10abac4b0183b85d6c341daf581431.png', '', 1, 10),
(5, 'Services', 'services', 'Services', 'meta description', '', '', 1, 12),
(4, 'Brands', 'brands', 'Brands', 'Brands of Products', 'c9a4f94b46d91e28e7a65838354d03451.png', '', 1, 8),
(25, 'Custom', 'custompage', 'Custom', 'Page', NULL, NULL, 0, 12),
(7, 'Images', 'image', 'Images Gallery', 'Images Gallery\r\n', 'c960d16f3cf63f31067161bff94108f81.png', '', 1, 16),
(3, 'Products', 'products', 'products', 'products', '', '', 1, 6),
(6, 'News / Events', 'news', 'News / Events', 'News / Events', '53bb95cfdc5c32765745bcbc6747d9b31.png', '<p>lol this</p>\r\n', 1, 14),
(2, 'Pages', 'pages', 'Pages', 'pages', '', '', 1, 4),
(8, 'Videos', 'video', 'Videos Gallery', 'Videos Gallery', '395a08298e40fdd55b41d04d13cc9ff61.png', '', 1, 18);
...
INSERT INTO `product` (`id`, `mid`, `mslug`, `pid`, `pslug`, `name`, `slug`, `brand`, `metak`, `metad`, `desp`, `feat`, `ordr`) VALUES
(57, NULL, NULL, 19, 'product-cat-1', 'Best in Class', 'best-in-class', 1, '', '', '', '1', 1),
(59, NULL, NULL, 19, 'product-cat-1', 'Rent Your Ride', 'rent-your-ride', NULL, NULL, NULL, NULL, '0', 2);
...
(19, 'Product Cat 1', 'product-cat-1', 'b08bf22d95389fb7613839ded3a0bc6b1.png', NULL, NULL, 1),
(20, 'Product Cat 32', 'product-cat-32', '127ea2a9bccf3c040709bce91c000c481.png', NULL, NULL, 2);
